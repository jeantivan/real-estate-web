...
import headerImage from "@/images/header-medium.webp";
            ...
            <Grid container px={2}>
              <Grid item xs={10} sm={6}>
                <Typography variant="h1" component="h1" mb={3} color="#fafafa">
                  <Box
                    ...
                    role="img"
                    aria-label="Avilatek Inmobiliaria"
                  >
                    <svg
              ...
              <Grid item xs={12} sm={8} mb={4}>
                <Typography
                  ...
                  lineHeight={1.5}
                >
                  Obcaecati repellendus blanditiis tenentur <br />
                  quis tempora esse earum <br />
                  alias voluptates.
                </Typography>
              </Grid>
              <Grid item xs={12}>
